...
addToCartRequest() async {
  ...
  var body = jsonEncode({
    "sch_code": LifeGoalsSchemes.encodedIndex,
    "f_sip_amount": SingleProductDetailsPage1.sipAmount,
    "sip_date": SingleProductDetailsPage1.date,
    "sch_d": LifeGoalsSchemes.idIndex,
  ...
  SingleProductDetailsPage1.message = decodedBody['msg'].toString();
  SingleProductDetailsPage1.status = decodedBody['status'].toString();
}
...
addToCartRequestOneTime() async {
  ...
  var body = jsonEncode({
    ...
    "sip_date": '0',
    "sch_d": LifeGoalsSchemes.idIndex,
    "f_lum_amount": SingleProductDetailsPage1.lumpSumAmount,
    "uid": '2052',
  });
  //String jsonBody = json.encode(body);
  final encoding = Encoding.getByName('utf-8');
...
class SingleProductDetailsPage1 extends StatefulWidget {
  ...
  static String routeName = '/LifeGoalsSchemeDetails';
  const SingleProductDetailsPage1({Key? key}) : super(key: key);
...
class _SingleProductDetailsPageState extends State<SingleProductDetailsPage1> {
  double miniamt = LifeGoalsSchemes.minAmt;
  var selectedDate;
  Future<List<ChartData>> _getChartData() async {
    ...
    Map<String, dynamic> body = {
      'get_nav': 'yes',
      'sch_code': LifeGoalsSchemes.encodedIsinForGraph,
    };
    Response response = await post(
      url,
      headers: headers,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  SfSlider(
                                                    ...
                                                    activeColor:
                                                        Color(0xFF5B16D0),
                                                    min: LifeGoalsSchemes
                                                        .lumpSumMin,
                                                    max: LifeGoalsSchemes
                                                        .lumpSumMax,
                                                    value: miniamt.toDouble(),
                                                    onChanged: (dynamic value) {
                                                      setState(() {
...
class DateCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Card(
        color: SingleProductDetailsPage1.isSelected == false
            ? Colors.white
